...
export default function ExpCard({ exp }) {
  ...
  return (
    <article className="flex flex-col overflow-hidden rounded-lg items-center space-y-4 flex-shrink-0 w-full md:w-[600px] xl:w-[900px] snap-center bg-slate-800/70 p-4 sm:p-10 opacity-60 hover:opacity-100 transition-opacity duration-200 max-h-[550px]">
      <motion.img
